...
int main()
{
    ...
    while(toupper(option) !='N'){ // This is the menu for entering the equations. while lets it loop tell user is done.
        ...
        // Kind of a weird way to go about it, but it works well.
...
// This doesn't have any checking for invalid input (-0.5 point)
void GCD_IO()
{
    unsigned long n,m;
...
void quadratic_IO()
{
    ...
    cout<<"c= ";
    cin>>c;
    // Call the quadratic function here, then r1 and r2 will magically become the correct answer.
    // (-0.25 point)
    if(pow(b,2.0)-4.0*a*c<=0){
        cout<<"imaginary number"<<endl;
    }
    // How do you know what r1 and r2 are if you haven't called the quadratic function yet?
    else{
